...
import type { FollowingsRepository, NotesRepository, EmojisRepository, NoteReactionsRepository, UserProfilesRepository, UserNotePiningsRepository, UsersRepository, FollowRequestsRepository } from '@/models/typeorm/_.js';
...
import type { MiFollowing } from '@/models/typeorm/Following.js';
