...
import type { MiUserProfile } from '@/models/typeorm/UserProfile.js';
import type { MiNote } from '@/models/typeorm/Note.js';
import type { MiAntenna } from '@/models/typeorm/Antenna.js';
import type { MiDriveFile } from '@/models/typeorm/DriveFile.js';
import type { MiDriveFolder } from '@/models/typeorm/DriveFolder.js';
...
import type { MiSystemWebhook } from '@/models/typeorm/SystemWebhook.js';
import type { MiMeta } from '@/models/typeorm/Meta.js';
import { MiAvatarDecoration, MiReversiGame, MiRole, MiRoleAssignment } from '@/models/typeorm/_.js';
