...
import type { IMentionedRemoteUsers } from '@/models/typeorm/Note.js';
import { MiNote } from '@/models/typeorm/Note.js';
import type { ChannelFollowingsRepository, ChannelsRepository, FollowingsRepository, InstancesRepository, MiFollowing, MiMeta, MutingsRepository, NotesRepository, NoteThreadMutingsRepository, UserListMembershipsRepository, UserProfilesRepository, UsersRepository } from '@/models/typeorm/_.js';
import type { MiDriveFile } from '@/models/typeorm/DriveFile.js';
import type { MiApp } from '@/models/typeorm/App.js';
import { concat } from '@/misc/prelude/array.js';
import { IdService } from '@/core/IdService.js';
import type { MiUser, MiLocalUser, MiRemoteUser } from '@/models/typeorm/User.js';
import type { IPoll } from '@/models/typeorm/Poll.js';
import { MiPoll } from '@/models/typeorm/Poll.js';
import { isDuplicateKeyValueError } from '@/misc/is-duplicate-key-value-error.js';
import type { MiChannel } from '@/models/typeorm/Channel.js';
