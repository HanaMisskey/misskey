...
import type { ReversiGamesRepository } from '@/models/mikroorm/_.js';
import { awaitAll } from '@/misc/prelude/await-all.js';
import type { Packed } from '@/misc/json-schema.js';
import type { } from '@/models/mikroorm/Blocking.js';
import type { MiReversiGame } from '@/models/mikroorm/ReversiGame.js';
...
export class ReversiGameEntityService {
	...
	public async packDetail(
		...
		const game = typeof src === 'object' ? src : await this.reversiGamesRepository.findOneOrFail({ id: src });
