...
import type { FollowingsRepository } from '@/models/mikroorm/_.js';
import { awaitAll } from '@/misc/prelude/await-all.js';
import type { Packed } from '@/misc/json-schema.js';
import type { MiUser } from '@/models/mikroorm/User.js';
import type { MiFollowing } from '@/models/mikroorm/Following.js';
...
export class FollowingEntityService {
	...
	public async pack(
		...
		const following = typeof src === 'object' ? src : await this.followingsRepository.findOneOrFail({ id: src });
