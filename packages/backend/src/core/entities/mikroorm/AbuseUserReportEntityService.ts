...
import type { AbuseUserReportsRepository } from '@/models/mikroorm/AbuseUserReportsRepository.js';
import type { MiAbuseUserReport } from '@/models/mikroorm/AbuseUserReport.js';
...
export class AbuseUserReportEntityService {
	...
	public async pack(
		...
		const report = typeof src === 'object' ? src : await this.abuseUserReportsRepository.findOneOrFail({ id: src });
