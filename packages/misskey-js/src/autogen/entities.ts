...
export type AdminAccountsFindByStripeCustomerRequest = operations['admin___accounts___find-by-stripe-customer']['requestBody']['content']['application/json'];
export type AdminAccountsFindByStripeCustomerResponse = operations['admin___accounts___find-by-stripe-customer']['responses']['200']['content']['application/json'];
...
export type AdminRefreshUserSubscriptionStatusRequest = operations['admin___refresh-user-subscription-status']['requestBody']['content']['application/json'];
...
export type AdminSubscriptionPlansCreateRequest = operations['admin___subscription-plans___create']['requestBody']['content']['application/json'];
export type AdminSubscriptionPlansCreateResponse = operations['admin___subscription-plans___create']['responses']['200']['content']['application/json'];
export type AdminSubscriptionPlansUpdateRequest = operations['admin___subscription-plans___update']['requestBody']['content']['application/json'];
export type AdminSubscriptionPlansArchiveRequest = operations['admin___subscription-plans___archive']['requestBody']['content']['application/json'];
...
export type IBskMigrateGetMiauthIdResponse = operations['i___bsk-migrate___get-miauth-id']['responses']['200']['content']['application/json'];
export type IBskMigrateStatusResponse = operations['i___bsk-migrate___status']['responses']['200']['content']['application/json'];
