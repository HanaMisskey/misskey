...
export type PremiumCancelExecuteRequest = operations['premium___cancel___execute']['requestBody']['content']['application/json'];
export type PremiumCancelExecuteResponse = operations['premium___cancel___execute']['responses']['200']['content']['application/json'];
export type PremiumCancelPreviewRequest = operations['premium___cancel___preview']['requestBody']['content']['application/json'];
export type PremiumCancelPreviewResponse = operations['premium___cancel___preview']['responses']['200']['content']['application/json'];
export type PremiumPlansResponse = operations['premium___plans']['responses']['200']['content']['application/json'];
export type PremiumPortalRequest = operations['premium___portal']['requestBody']['content']['application/json'];
export type PremiumPortalResponse = operations['premium___portal']['responses']['200']['content']['application/json'];
export type PremiumStatusResponse = operations['premium___status']['responses']['200']['content']['application/json'];
export type PremiumSubscribeExecuteRequest = operations['premium___subscribe___execute']['requestBody']['content']['application/json'];
export type PremiumSubscribeExecuteResponse = operations['premium___subscribe___execute']['responses']['200']['content']['application/json'];
export type PremiumSubscribePreviewRequest = operations['premium___subscribe___preview']['requestBody']['content']['application/json'];
export type PremiumSubscribePreviewResponse = operations['premium___subscribe___preview']['responses']['200']['content']['application/json'];
