...
export type DriveFilesMultipartAbortRequest = operations['drive___files___multipart___abort']['requestBody']['content']['application/json'];
export type DriveFilesMultipartCompleteRequest = operations['drive___files___multipart___complete']['requestBody']['content']['application/json'];
export type DriveFilesMultipartCompleteResponse = operations['drive___files___multipart___complete']['responses']['200']['content']['application/json'];
export type DriveFilesMultipartCreateRequest = operations['drive___files___multipart___create']['requestBody']['content']['application/json'];
export type DriveFilesMultipartCreateResponse = operations['drive___files___multipart___create']['responses']['200']['content']['application/json'];
export type DriveFilesMultipartUploadPartRequest = operations['drive___files___multipart___upload-part']['requestBody']['content']['multipart/form-data'];
export type DriveFilesMultipartUploadPartResponse = operations['drive___files___multipart___upload-part']['responses']['200']['content']['application/json'];
