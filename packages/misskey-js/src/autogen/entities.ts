...
export type NotesHanamisearchV2Request = operations['notes___hanamisearch-v2']['requestBody']['content']['application/json'];
export type NotesHanamisearchV2Response = operations['notes___hanamisearch-v2']['responses']['200']['content']['application/json'];
