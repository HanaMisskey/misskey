...
export type PremiumSubscribeRequest = operations['premium___subscribe']['requestBody']['content']['application/json'];
export type PremiumSubscribeResponse = operations['premium___subscribe']['responses']['200']['content']['application/json'];
