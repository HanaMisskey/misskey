...
export type ICustomerPortalResponse = operations['i___customer-portal']['responses']['200']['content']['application/json'];
...
export type IRegisterSubscriptionRequest = operations['i___register-subscription']['requestBody']['content']['application/json'];
